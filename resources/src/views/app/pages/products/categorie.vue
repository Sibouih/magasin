      ...
      <b-modal hide-footer size="md" id="New_Category" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Category">
          <b-row>
            ...
            <!-- -Category Image -->
            <b-col md="12">
              <validation-provider name="Image" ref="Image" rules="mimes:image/*|size:800">
                <b-form-group slot-scope="{validate, valid, errors }" :label="$t('CategorieImage')">
                  <input
